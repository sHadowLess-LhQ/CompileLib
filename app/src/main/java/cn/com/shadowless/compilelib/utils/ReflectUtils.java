...
package cn.com.shadowless.compilelib.utils;
...
public final class ReflectUtils {
                ...
                if (match != null) {
                    throw new IllegalArgumentException(
                            String.format(Locale.ENGLISH,
                                    "Reference to field %s is ambiguous relative to %s; a matching field exists on "
    ...
    public static Object readField(Class<?> c, Object target, String fieldName)
            throws IllegalAccessException, NoSuchFieldException {
    ...
    public static void writeField(Object target, String fName, Object value)
            throws NoSuchFieldException, IllegalAccessException {
        writeField(target.getClass(), target, fName, value);
    }

    public static void writeField(Class<?> c, Object object, String fName, Object value)
            throws NoSuchFieldException, IllegalAccessException {
            ...
            try {
                ...
                if (match != null) {
                    throw new IllegalArgumentException(String.format(Locale.ENGLISH,
                            "Reference to field %s is ambiguous relative to %s; a matching field exists on two or "
                                    + "more implemented interfaces.",
                            fieldName, cls));
                }
                match = test;
            } catch (final NoSuchMethodException ex) { // NOPMD
    ...
    public static Object invokeMethod(final Object object, final String methodName, Class<?>[] methodParamTypes,
            Object... args)
